...
//   final String baseUrlimg = 'https://imp-model-widely.ngrok-free.app/api/user/createAnhDaiDien';
        ...
        if (token != null) {
          ...
          if (userId != null) {
            ...
            if (user != null) {
              ...
              SharedPreferences prefs = await SharedPreferences.getInstance();
              await prefs.setString('tenNguoiDung', user.tenNguoiDung ?? '');
              await prefs.setString('tenNguoiDung', user.gmail ?? '');
              await prefs.setString('userId', userId);
              await prefs.setString('token', token); // Save token for future use
              return user;
            }
          }
        }
