  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: onTap,
        items: const [
          BottomNavigationBarItem(icon: Icon(Icons.chat), label: 'Chat', backgroundColor: Color.fromRGBO(41, 87, 35, 1)),
          BottomNavigationBarItem(icon: Icon(Icons.home_outlined), label: 'Chat', backgroundColor: Color.fromRGBO(41, 87, 35, 1)),
          BottomNavigationBarItem(icon: Icon(Icons.person), label: 'Chat', backgroundColor: Color.fromRGBO(41, 87, 35, 1)),
        ],
      ),
    );
  }
